...
mipmap: source 1247 words, computing 5 levels: 20, 50, 125, 312, 374 (qwen2.5-coder:14b, num_ctx=16384)
...
mipmap: source 1234 字, computing 4 levels: 30, 75, 188, 370 (qwen2.5-coder:14b, num_ctx=16384)
...
```
